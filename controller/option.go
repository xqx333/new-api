...
func UpdateOption(c *gin.Context) {
	...
	case "ModelRequestRateLimitUser":
		err = setting.CheckModelRequestRateLimitUser(option.Value)
		if err != nil {
			c.JSON(http.StatusOK, gin.H{
				"success": false,
				"message": err.Error(),
	...
	case "ModelRequestRateLimitModel":
		err = setting.CheckModelRequestRateLimitModel(option.Value)
		if err != nil {
			c.JSON(http.StatusOK, gin.H{
				"success": false,
				"message": err.Error(),
	...
	case "GlobalModelRateLimitModel":
		err = setting.CheckGlobalModelRateLimitModel(option.Value)
		if err != nil {
			c.JSON(http.StatusOK, gin.H{
				"success": false,
				"message": err.Error(),
