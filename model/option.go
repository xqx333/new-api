...
func InitOptionMap() {
	...
	common.OptionMap["ModelRequestRateLimitUserModel"] = setting.ModelRequestRateLimitUserModel2JSONString()
	...
	common.OptionMap["ModelRequestRateLimitHideDetailsEnabled"] = strconv.FormatBool(setting.ModelRequestRateLimitHideDetailsEnabled)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" || key == "SMTPInsecureSkipVerify" {
		...
		case "ModelRequestRateLimitHideDetailsEnabled":
			setting.ModelRequestRateLimitHideDetailsEnabled = boolValue
	...
	case "ModelRequestRateLimitUserModel":
		err = setting.UpdateModelRequestRateLimitUserModelByJSONString(value)
	case "RetryTimes":
