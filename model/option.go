...
func InitOptionMap() {
	...
	// Per-user retry times override (JSON: {"123":1})
	common.OptionMap["UserRetryTimesOverride"] = "{}"
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "UserRetryTimesOverride":
		err = common.UpdateUserRetryTimesFromJSONString(value)
